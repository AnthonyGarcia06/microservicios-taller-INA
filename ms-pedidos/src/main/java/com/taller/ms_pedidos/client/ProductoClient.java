...
public class ProductoClient {
    ...
    public void descontarStock(Long productoId, int cantidad) {
        restClient.patch()
                .uri(productosUrl + "/api/productos/{id}/descontar-stock?cantidad={cantidad}", productoId, cantidad)
                .retrieve()
                .toBodilessEntity();
    }
    ...
    public void reponerStock(Long productoId, int cantidad) {
        restClient.patch()
                .uri(productosUrl + "/api/productos/{id}/reponer-stock?cantidad={cantidad}", productoId, cantidad)
                .retrieve()
                .toBodilessEntity();
    }
