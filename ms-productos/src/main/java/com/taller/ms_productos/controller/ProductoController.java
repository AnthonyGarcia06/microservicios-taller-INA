...
public class ProductoController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<ProductoResponseDTO> listarPorId(@PathVariable Long id) {
        return ResponseEntity.status(HttpStatus.OK).body(productoService.listarPorId(id));
    }
    ...
    public ResponseEntity<ProductoResponseDTO> descontarStock(@PathVariable Long id, @RequestParam Integer cantidad) {
        return ResponseEntity.status(HttpStatus.OK).body(productoService.descontarStock(id, cantidad));
    }

    @PatchMapping("/{id}/reponer-stock")
    public ResponseEntity<ProductoResponseDTO> reponerStock(@PathVariable Long id, @RequestParam Integer cantidad) {
